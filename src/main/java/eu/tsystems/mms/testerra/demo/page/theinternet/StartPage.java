...
public class StartPage extends Page {
    ...
    @Check
    private GuiElement headerElement = new GuiElement(this.getWebDriver(), Locate.by(By.cssSelector("h1.heading")));

    @Check
    private GuiElement navLinkDragAndDrop = new GuiElement(this.getWebDriver(), Locate.by(By.linkText("Drag and Drop")));

    @Check
    private GuiElement navLinkAddAndRemoveElements = new GuiElement(this.getWebDriver(), Locate.by(By.linkText("Add/Remove Elements")));
    @Check
    private GuiElement navLinkTables = new GuiElement(this.getWebDriver(), Locate.by(By.linkText("Sortable Data Tables")));
